...
function calcular() {
  ...
  div_resultado.innerHTML += `
  <br>
                             <h3> Gastos com multas e gastos em caso de acidentes: </h3> <br>
                              <p>A <span> NFPA </span>, organização global de segurança contra incêndios, 
                              estabelece normas para <span> reduzir mortes, ferimentos e perdas 
                              financeiras devido a incêndios.</span> 
                              A falta de monitoramento pode resultar em <span> multas elevadas </span>, que 
                              <span> resultam em: R$${multa.toFixed(2)} </span>.
                              Com reincidências a multa pode vir a <span> dobrar: R$${multa_dobrada.toFixed(2)} </span>, na terceira inpeção, 
                              há risco de suspensão das atividades, afetando as finanças e 
                              expondo os <span> funcionários </span> a <span> riscos graves de saúde e segurança </span, que poderiam chegar
                              à <span> R$${patrimonial} </span>.
                              `
